...
int main(void){
    ...
    while(true){
        ...
        ADCProcessorTrigger(ADC0_BASE, 2); //Se dispara el secuenciador 2 del ADC 0.
            ...
            V_Pos = (PromedioPotV*7)/4060; //Ecuación que detetermina el número de Fila (0 a 7) según se mueve el Pot de movimiento vertical.
            Row = (int)V_Pos;
            H_Pos = (PromedioPotH*7)/4060; //Ecuación que detetermina el número de Columna (0 al 7) según se mueve el Pot de movimiento horizontal.
            Column = 7 - (int)H_Pos;
